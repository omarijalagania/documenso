...
import type { TemplatePageViewProps } from '~/app/[locale]/(dashboard)/templates/[id]/template-page-view';
import { TemplatePageView } from '~/app/[locale]/(dashboard)/templates/[id]/template-page-view';

...
import type { TemplatesPageViewProps } from '~/app/[locale]/(dashboard)/templates/templates-page-view';
import { TemplatesPageView } from '~/app/[locale]/(dashboard)/templates/templates-page-view';

...
import type { DocumentsPageViewProps } from '~/app/[locale]/(dashboard)/documents/documents-page-view';
import { DocumentsPageView } from '~/app/[locale]/(dashboard)/documents/documents-page-view';

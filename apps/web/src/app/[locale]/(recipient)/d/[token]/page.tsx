...
import { DocumentAuthProvider } from '~/app/[locale]/(signing)/sign/[token]/document-auth-provider';
import { SigningProvider } from '~/app/[locale]/(signing)/sign/[token]/provider';
